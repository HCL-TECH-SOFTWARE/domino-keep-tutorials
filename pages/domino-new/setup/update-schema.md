...
Creating a NSF automatically creates a basic **schema**, although with nothing exposed.
</div>
</div>
...
4. Set the URL as "&#123;&#123;SETUP_HOST&#125;&#125;/schema?configName=customers&nsfPath=customers.nsf".
